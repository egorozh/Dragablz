...
public class Layout : ContentControl, IStyleable
{
    ...
    {
        get => (IInterLayoutClient) GetValue(InterLayoutClientProperty);
    ...
    {
        get => (bool) GetValue(IsParticipatingInDragProperty);
    ...
    {
        get => (bool) GetValue(IsFloatDropZoneEnabledProperty);
    ...
    {
        get => (Thickness) GetValue(FloatingItemsContainerMarginProperty);
    ...
    {
        get => (IEnumerable) GetValue(FloatingItemsSourceProperty);
    ...
    {
        get => (Style) GetValue(FloatingItemsControlStyleProperty);
    ...
    {
        get => (Style) GetValue(FloatingItemContainerStyleProperty);
    ...
    {
        get => (StyleSelector) GetValue(FloatingItemContainerStyleSelectorProperty);
    ...
    {
        get => (DataTemplate) GetValue(FloatingItemTemplateProperty);
    ...
    {
        get => (DataTemplateSelector) GetValue(FloatingItemTemplateSelectorProperty);
    ...
    {
        get => (ClosingFloatingItemCallback) GetValue(ClosingFloatingItemCallbackProperty);
