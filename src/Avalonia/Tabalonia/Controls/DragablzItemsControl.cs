...
{        
    ...
    {
        get => (IItemsOrganiser) GetValue(ItemsOrganiserProperty);
    ...
    {
        get => (PositionMonitor) GetValue(PositionMonitorProperty);
    ...
    {
        get => (double) GetValue(ItemsPresenterWidthProperty);
    ...
    {
        get => (double) GetValue(ItemsPresenterHeightProperty);
