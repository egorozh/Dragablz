...
public class FluentTheme : IStyle, IResourceProvider
{
    ...
    {
        FluentThemeMode.Dark => new Uri("avares://Avalonium/Themes/FluentDark.axaml", UriKind.Absolute),
        _ => new Uri("avares://Avalonium/Themes/FluentLight.axaml", UriKind.Absolute),
    };
}